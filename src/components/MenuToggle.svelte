...
<button class="menu-icon" on:click={handleClick}>
	<slot />
</button>
<ul class="menu-nav {hide?"hidden":""}">
	<li class="mobile-nav--menu-item"><a class="link" href="/">
		<img 
			src="/assets/MowerLogo.jpg"
			width="50"
			height="50"
			alt="she gone"
		>
	...
	<li class="mobile-nav--menu-item">
		<div class="socials">
			...
			<a class="social" href="https://facebook.com/me">
				<svg class="socialIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
					<path
